...
- **Comprehensive CLI Tool**: Take advantage of a robust command-line interface for generating documentation quickly and easily.
...
<Navigation next="/docs/quick-setup"/>